// Thanks to https://github.com/mnahkies/ng-qrcode/blob/master/projects/ng-qrcode
...
import { RGBAColor } from '../../@types/global';
...
export class QrCodeDirective implements OnChanges {
  ...
  async ngOnChanges() {
    ...
    await toCanvas(canvas, this.value, {
    ...
    if (centerImageSrc && context) {
      ...
      centerImage.onload = () => {
        context.drawImage(
          ...
          canvas.height / 2 - centerImageHeight / 2,
          centerImageWidth,
          centerImageHeight,
        );
      };
