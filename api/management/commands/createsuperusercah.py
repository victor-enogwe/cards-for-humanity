...
from django.contrib.auth.management.commands.createsuperuser import Command, NotRunningInTTYException
    ...
    def handle(self, *args: Any, **options: Any) -> Optional[str]:
        ...
        try:
            if options['interactive']:
                ...
                while PASSWORD_FIELD in password_data and password_data[PASSWORD_FIELD] is None:
            ...
            self.UserModel._default_manager.db_manager(
                database
            ).create_superuser(email=email, password=password_data[PASSWORD_FIELD])
